...
**Last updated:** 2026-05-17 · **Latest shipped:** `v0.6.12` (Bazel disk cache + `.cxx` + in-app update; scan contract **2.8.0** — see [v0.6.12-manifest.md](v0.6.12-manifest.md)) · **Development head:** `v0.7.x` trust/community track
