...
**Last updated:** 2026-06-07 · **Latest shipped:** `v1.0.0` · **Next:** `v1.1+` via [v1.0-roadmap.md](v1.0-roadmap.md)
...
## Phase F — `v0.9.x` · Storage pressure relief (secure migrations)

**Goal:** Help users with constrained OS drives avoid destructive “delete the app data folder” cycles by providing a **safe directory migration** workflow (move + junction) for high-churn developer tools.
...
| `v0.9.11` | SECURITY.md + parity hardening + 1.0 QA prep | Shipped — [v0.9.11-manifest.md](v0.9.11-manifest.md) |
| `v1.0.0` | GA developer cleanup (three OS) | Shipped — [v1.0.0-manifest.md](v1.0.0-manifest.md) |
...
| [v0.9.11-manifest.md](v0.9.11-manifest.md) | Trust hardening (in dev) |
