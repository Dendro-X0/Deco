        ...
        {entries.map((entry) => (
          ...
          >
            ...
            <p className="font-mono break-all text-[11px]">
              <span className="text-muted-foreground">{t('settings.toolMigration.source')}</span> {entry.source_path}
            </p>
            <p className="font-mono break-all text-[11px]">
              <span className="text-muted-foreground">{t('settings.toolMigration.dest')}</span> {entry.dest_path}
            </p>
